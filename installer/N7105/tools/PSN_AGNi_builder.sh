...
AGNI_PURECM_VER="2.9.0"
AGNI_PURECM_SELINUX="PERMISSIVE"
DEVICE_MODEL="N7105,N7105T,SGH-I317,SGH-T889,SGH-I317M"
DEVICE_NAME="t0lte,t0ltedv,t0lteatt,t0ltetmo,t0ltecan,t0ltevl"
...
if ! [ "`grep AGNI /tmp/extracted/fstab.smdk4x12`" ];
	then
	awk '/mmcblk0p13/{print "# AGNI_SYSTEM"} {print}' /tmp/extracted/fstab.smdk4x12 > /tmp/extracted/fstab.smdk4x12-temp
	mv /tmp/extracted/fstab.smdk4x12-temp /tmp/extracted/fstab.smdk4x12
	awk '/mmcblk0p16/{print "# AGNI_DATA"} {print}' /tmp/extracted/fstab.smdk4x12 > /tmp/extracted/fstab.smdk4x12-temp
	mv /tmp/extracted/fstab.smdk4x12-temp /tmp/extracted/fstab.smdk4x12
	awk '/mmcblk0p12/{print "# AGNI_CACHE"} {print}' /tmp/extracted/fstab.smdk4x12 > /tmp/extracted/fstab.smdk4x12-temp
	mv /tmp/extracted/fstab.smdk4x12-temp /tmp/extracted/fstab.smdk4x12
	awk '/mmcblk0p14/{print "# AGNI_PRELOAD"} {print}' /tmp/extracted/fstab.smdk4x12 > /tmp/extracted/fstab.smdk4x12-temp
	mv /tmp/extracted/fstab.smdk4x12-temp /tmp/extracted/fstab.smdk4x12
	sed '/mmcblk0p13/d' /tmp/extracted/fstab.smdk4x12 > /tmp/extracted/fstab.smdk4x12-temp
	mv /tmp/extracted/fstab.smdk4x12-temp /tmp/extracted/fstab.smdk4x12
	sed '/mmcblk0p16/d' /tmp/extracted/fstab.smdk4x12 > /tmp/extracted/fstab.smdk4x12-temp
	mv /tmp/extracted/fstab.smdk4x12-temp /tmp/extracted/fstab.smdk4x12
	sed '/mmcblk0p12/d' /tmp/extracted/fstab.smdk4x12 > /tmp/extracted/fstab.smdk4x12-temp
	mv /tmp/extracted/fstab.smdk4x12-temp /tmp/extracted/fstab.smdk4x12
	sed '/mmcblk0p14/d' /tmp/extracted/fstab.smdk4x12 > /tmp/extracted/fstab.smdk4x12-temp
	mv /tmp/extracted/fstab.smdk4x12-temp /tmp/extracted/fstab.smdk4x12
	echo " Applied modifications to fstab.smdk4x12 ! " >> $AGNI_LOG_FILE
fi
if ! [ "`grep f2fs /tmp/extracted/lpm.rc`" ];
	then
	awk '/mmcblk0p13/{print "    mount f2fs /dev/block/mmcblk0p13 /system ro wait noatime nodiratime inline_xattr active_logs=2"} {print}' /tmp/extracted/lpm.rc > /tmp/extracted/lpm.rc-temp
	mv /tmp/extracted/lpm.rc-temp /tmp/extracted/lpm.rc
	#awk '/mmcblk0p16/{print "    mount f2fs /dev/block/mmcblk0p16 /data wait noatime nosuid nodev nodiratime inline_xattr active_logs=2"} {print}' /tmp/extracted/lpm.rc > /tmp/extracted/lpm.rc-temp
	#mv /tmp/extracted/lpm.rc-temp /tmp/extracted/lpm.rc
